...
/**
 * \class left_fold Collapses a sequence starting from left using a functor.
 * \param Sequence The input sequence
...
/**
 * \class accumulate Alias for left_fold.
 * \ref left_fold
 */
template<class Seq,template<class ... > class F> using accumulate = left_fold<Seq,F>;

/**
 * \class right_fold Collapses a sequence starting from right using a functor.
 * \param Sequence The input sequence
 * \param F The functor; F<T,U> must be a valid expression
