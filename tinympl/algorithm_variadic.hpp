 ...
 * \sa tinympl::count
 */
template<typename T,class ... Args> struct count : count_if< bind<equal_to,arg1,T>::template eval_t, Args ... > {};
 ...
 * \sa tinympl::find
 */
template<typename T,class ... Args> struct find : find_if< bind<equal_to,arg1,T>::template eval_t, Args ... > {};
...
template<template<class ... T> class F,template<class ...> class Out,class ... Args> struct remove_if : copy_if< bind<logical_not,bind<F,arg1> >::template eval,Out,Args...> {};
 ...
 * \sa tinympl::remove
 */
template< typename T, template<class ... > class Out,class ... Args> struct remove : remove_if< bind<equal_to, arg1,T>::template eval_t,Out,Args...> {};
 ...
 * \sa tinympl::replace
 */
template<class Old,class New,template<class...> class Out,class ... Args> struct replace : replace_if<bind<equal_to,arg1,Old>::template eval_t,New,Out,Args...> {};
 ...
 */
template<template<class ... > class Cmp,class ... Args> struct max_element : min_element< bind<Cmp,arg2,arg1 >::template eval_t,Args... > {};
